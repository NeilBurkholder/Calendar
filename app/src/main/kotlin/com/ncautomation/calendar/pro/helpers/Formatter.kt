...
object Formatter {
    ...
    fun getMonthName(context: Context, id: Int) = context.resources.getStringArray(com.ncautomation.commons.R.array.months)[id - 1]

    fun getShortMonthName(context: Context, id: Int) = context.resources.getStringArray(com.ncautomation.commons.R.array.months_short)[id - 1]
