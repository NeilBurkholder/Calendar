...
import com.ncautomation.calendar.pro.databinding.DialogRepeatLimitTypePickerBinding
...
import com.ncautomation.calendar.pro.helpers.getJavaDayOfWeekFromJoda
import com.ncautomation.calendar.pro.helpers.getNowSeconds
...
class RepeatLimitTypePickerDialog(val activity: Activity, var repeatLimit: Long, val startTS: Long, val callback: (repeatLimit: Long) -> Unit) {
    ...
    init {
        ...
        activity.getAlertDialogBuilder()
            .setPositiveButton(com.ncautomation.commons.R.string.ok) { _, _ -> confirmRepetition() }
