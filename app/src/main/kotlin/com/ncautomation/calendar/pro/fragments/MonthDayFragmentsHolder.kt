...
import com.ncautomation.calendar.pro.adapters.MyMonthDayPagerAdapter
import com.ncautomation.calendar.pro.databinding.FragmentMonthsDaysHolderBinding
import com.ncautomation.calendar.pro.extensions.getMonthCode
import com.ncautomation.calendar.pro.helpers.DAY_CODE
import com.ncautomation.calendar.pro.helpers.Formatter
import com.ncautomation.calendar.pro.helpers.MONTHLY_DAILY_VIEW
...
class MonthDayFragmentsHolder : MyFragmentHolder(), NavigationListener {
    ...
    override fun showGoToDateDialog() {
        ...
        activity?.getAlertDialogBuilder()!!
            ...
            .setPositiveButton(com.ncautomation.commons.R.string.ok) { _, _ -> datePicked(dateTime, datePicker) }
            .apply {
