...
class EventListWidgetAdapter(val context: Context, val intent: Intent) : RemoteViewsService.RemoteViewsFactory {
    ...
    private var smallMargin = context.resources.getDimension(com.ncautomation.commons.R.dimen.small_margin).toInt()
    private var normalMargin = context.resources.getDimension(com.ncautomation.commons.R.dimen.normal_margin).toInt()
