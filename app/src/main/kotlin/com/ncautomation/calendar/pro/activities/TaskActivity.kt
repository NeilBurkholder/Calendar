...
import com.ncautomation.calendar.pro.databinding.ActivityTaskBinding
...
import com.ncautomation.calendar.pro.models.Reminder
...
class TaskActivity : SimpleActivity() {
    ...
    private fun updateTaskCompletedButton() {
        if (mTaskCompleted) {
            binding.toggleMarkComplete.background = ContextCompat.getDrawable(this, com.ncautomation.commons.R.drawable.button_background_stroke)
    ...
    private fun getRepeatXthDayInMonthString(includeBase: Boolean, repeatRule: Int): String {
        ...
        val monthString = resources.getStringArray(com.ncautomation.commons.R.array.in_months)[mTaskDateTime.monthOfYear - 1]
