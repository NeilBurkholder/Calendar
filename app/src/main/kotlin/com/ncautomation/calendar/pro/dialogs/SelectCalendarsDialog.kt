...
import com.ncautomation.calendar.pro.databinding.CalendarItemAccountBinding
import com.ncautomation.calendar.pro.databinding.CalendarItemCalendarBinding
import com.ncautomation.calendar.pro.databinding.DialogSelectCalendarsBinding
...
class SelectCalendarsDialog(val activity: SimpleActivity, val callback: () -> Unit) {
    ...
    init {
        ...
        activity.getAlertDialogBuilder()
            .setPositiveButton(com.ncautomation.commons.R.string.ok) { _, _ -> confirmSelection() }
