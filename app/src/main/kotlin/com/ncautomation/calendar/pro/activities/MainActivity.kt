...
import com.ncautomation.calendar.pro.adapters.EventListAdapter
import com.ncautomation.calendar.pro.adapters.QuickFilterEventTypeAdapter
import com.ncautomation.calendar.pro.databases.EventsDatabase
import com.ncautomation.calendar.pro.databinding.ActivityMainBinding
import com.ncautomation.calendar.pro.dialogs.SelectEventTypesDialog
import com.ncautomation.calendar.pro.dialogs.SetRemindersDialog
import com.ncautomation.calendar.pro.extensions.*
import com.ncautomation.calendar.pro.fragments.*
import com.ncautomation.calendar.pro.helpers.*
import com.ncautomation.calendar.pro.helpers.Formatter
import com.ncautomation.calendar.pro.helpers.IcsImporter.ImportResult
import com.ncautomation.calendar.pro.jobs.CalDAVUpdateListener
import com.ncautomation.calendar.pro.models.Event
import com.ncautomation.calendar.pro.models.ListEvent
import com.ncautomation.calendar.pro.models.ListItem
import com.ncautomation.calendar.pro.models.ListSectionDay
...
import com.ncautomation.commons.views.MyLinearLayoutManager
...
class MainActivity : SimpleActivity(), RefreshRecyclerViewListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appLaunched(com.ncautomation.calendar.pro.BuildConfig.APPLICATION_ID)
        setupOptionsMenu()
        refreshMenuItems()
        ...
        if (isPackageInstalled("com.ncautomation.calendar")) {
            ConfirmationDialog(
                activity = this,
                message = "",
                messageId = com.ncautomation.commons.R.string.upgraded_from_free_calendar,
    ...
    private fun resetActionBarTitle() {
        binding.mainMenu.updateHintText(getString(com.ncautomation.commons.R.string.search))
    }
    ...
    private fun tryAddBirthdays() {
        handlePermission(PERMISSION_READ_CONTACTS) {
            if (it) {
                ...
                toast(com.ncautomation.commons.R.string.no_contacts_permission)
            }
        }
    }
    ...
    private fun handleParseResult(result: ImportResult) {
        toast(
            when (result) {
                ImportResult.IMPORT_NOTHING_NEW -> com.ncautomation.commons.R.string.no_new_items
    ...
    private fun animateFabIcon(showPlus: Boolean) {
        val newDrawableId = if (showPlus) {
            com.ncautomation.commons.R.drawable.ic_plus_vector
        } else {
    ...
    private fun launchAbout() {
        ...
        startAboutActivity(R.string.app_name, licenses, com.ncautomation.calendar.pro.BuildConfig.VERSION_NAME, faqItems, true)
    }
    ...
    private fun searchQueryChanged(text: String) {
        ...
        val placeholderTextId = if (config.displayEventTypes.isEmpty()) {
            ...
            com.ncautomation.commons.R.string.no_items_found
        }
    ...
    private fun checkWhatsNewDialog() {
        arrayListOf<Release>().apply {
            ...
            checkWhatsNew(this, com.ncautomation.calendar.pro.BuildConfig.VERSION_CODE)
        }
    }
}
