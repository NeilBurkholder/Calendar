...
import com.ncautomation.calendar.pro.databinding.*
import com.ncautomation.calendar.pro.dialogs.EditRepeatingEventDialog
...
import com.ncautomation.calendar.pro.models.EventWeeklyView
...
class WeekFragment : Fragment(), WeeklyCalendar {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        scrollView.onGlobalLayout {
            if (fullHeight < scrollView.height) {
                scrollView.layoutParams.height = fullHeight - res.getDimension(com.ncautomation.commons.R.dimen.one_dp).toInt()
            }
    ...
    private fun setupDayLabels() {
        ...
        for (i in 0 until config.weeklyViewDays) {
            ...
            val labelIDs = if (useLongerDayLabels) {
                com.ncautomation.commons.R.array.week_days_short
            } else {
                com.ncautomation.commons.R.array.week_day_letters
            }
            ...
            val textColor = if (isPrintVersion) {
                resources.getColor(com.ncautomation.commons.R.color.theme_light_text_color)
    ...
    private fun updateViewScale() {
        ...
        val oneDp = res.getDimension(com.ncautomation.commons.R.dimen.one_dp).toInt()
    ...
    private fun addCurrentTimeIndicator() {
        if (todayColumnIndex != -1) {
            ...
            currentTimeView = WeekNowMarkerBinding.inflate(layoutInflater).root.apply {
                ...
                val extraWidth = res.getDimension(com.ncautomation.commons.R.dimen.activity_margin).toInt()
