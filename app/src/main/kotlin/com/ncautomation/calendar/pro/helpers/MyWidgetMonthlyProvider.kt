...
class MyWidgetMonthlyProvider : AppWidgetProvider() {
    ...
    private val monthlyCalendar = object : MonthlyCalendar {
        override fun updateMonthlyCalendar(context: Context, month: String, days: ArrayList<DayMonthly>, checkedEvents: Boolean, currTargetDate: DateTime) {
            ...
            appWidgetManager.getAppWidgetIds(getComponentName(context)).forEach {
                ...
                var bmp = resources.getColoredBitmap(com.ncautomation.commons.R.drawable.ic_chevron_left_vector, textColor)
                views.setImageViewBitmap(R.id.top_left_arrow, bmp)

                bmp = resources.getColoredBitmap(com.ncautomation.commons.R.drawable.ic_chevron_right_vector, textColor)
                ...
                bmp = resources.getColoredBitmap(com.ncautomation.commons.R.drawable.ic_plus_vector, textColor)
    ...
    private fun updateDayLabels(context: Context, views: RemoteViews, resources: Resources, textColor: Int) {
        ...
        val packageName = context.packageName
        val letters = context.resources.getStringArray(com.ncautomation.commons.R.array.week_day_letters)
