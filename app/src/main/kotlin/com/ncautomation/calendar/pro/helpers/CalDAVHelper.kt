...
import com.ncautomation.calendar.pro.objects.States.isUpdatingCalDAV
import com.ncautomation.commons.extensions.*
import com.ncautomation.commons.helpers.PERMISSION_READ_CALENDAR
import com.ncautomation.commons.helpers.PERMISSION_WRITE_CALENDAR
    ...
    private fun setupCalDAVEventReminders(event: Event) {
        ...
        event.getReminders().forEach {
            ...
            try {
                ...
                context.toast(com.ncautomation.commons.R.string.unknown_error_occurred)
            }
        }
    }
