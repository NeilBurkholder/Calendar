...
import com.ncautomation.calendar.pro.extensions.getWeeklyViewItemHeight
...
class WeeklyViewGrid(context: Context, attrs: AttributeSet, defStyle: Int) : View(context, attrs, defStyle) {
    ...
    init {
        paint.color = context.resources.getColor(com.ncautomation.commons.R.color.divider_grey)
    }
