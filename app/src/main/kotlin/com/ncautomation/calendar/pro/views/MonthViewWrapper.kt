...
import com.ncautomation.calendar.pro.databinding.MonthViewBackgroundBinding
import com.ncautomation.calendar.pro.databinding.MonthViewBinding
...
class MonthViewWrapper(context: Context, attrs: AttributeSet, defStyle: Int) : FrameLayout(context, attrs, defStyle) {
    ...
    init {
        val normalTextSize = resources.getDimensionPixelSize(com.ncautomation.commons.R.dimen.normal_text_size).toFloat()
    ...
    private fun setupHorizontalOffset() {
        horizontalOffset = if (context.config.showWeekNumbers) {
            resources.getDimensionPixelSize(com.ncautomation.commons.R.dimen.smaller_text_size) * 2
        } else {
            0
        }
    }
