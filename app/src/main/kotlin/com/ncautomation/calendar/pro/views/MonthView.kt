package com.ncautomation.calendar.pro.views
...
import com.ncautomation.calendar.pro.helpers.COLUMN_COUNT
import com.ncautomation.calendar.pro.helpers.Formatter
import com.ncautomation.calendar.pro.helpers.ROW_COUNT
...
class MonthView(context: Context, attrs: AttributeSet, defStyle: Int) : View(context, attrs, defStyle) {
    ...
    init {
        ...
        val normalTextSize = resources.getDimensionPixelSize(com.ncautomation.commons.R.dimen.normal_text_size)
        ...
        val smallerTextSize = resources.getDimensionPixelSize(com.ncautomation.commons.R.dimen.smaller_text_size)
    ...
    private fun initWeekDayLetters() {
        dayLetters = context.withFirstDayOfWeekToFront(context.resources.getStringArray(com.ncautomation.commons.R.array.week_day_letters).toList())
    }
