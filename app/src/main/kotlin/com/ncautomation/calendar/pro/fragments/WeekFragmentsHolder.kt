...
import com.ncautomation.calendar.pro.adapters.MyWeekPagerAdapter
import com.ncautomation.calendar.pro.databinding.FragmentWeekHolderBinding
import com.ncautomation.calendar.pro.databinding.WeeklyViewHourTextviewBinding
import com.ncautomation.calendar.pro.extensions.*
import com.ncautomation.calendar.pro.helpers.Formatter
import com.ncautomation.calendar.pro.helpers.WEEKLY_VIEW
import com.ncautomation.calendar.pro.helpers.WEEK_START_DATE_TIME
import com.ncautomation.calendar.pro.interfaces.WeekFragmentListener
import com.ncautomation.calendar.pro.views.MyScrollView
import com.ncautomation.commons.extensions.*
import com.ncautomation.commons.helpers.WEEK_SECONDS
import com.ncautomation.commons.views.MyViewPager
import com.ncautomation.calendar.pro.views.*
...
class WeekFragmentsHolder : MyFragmentHolder(), WeekFragmentListener {
    ...
    private fun setupWeeklyActionbarTitle(timestamp: Long) {
        ...
        binding.weekViewWeekNumber.text = "${getString(com.ncautomation.commons.R.string.week_number_short)} $weekNumber"
    }
    ...
    override fun showGoToDateDialog() {
        ...
        activity?.getAlertDialogBuilder()!!
            ...
            .setPositiveButton(com.ncautomation.commons.R.string.ok) { _, _ -> dateSelected(dateTime, datePicker) }
            .apply {
    ...
    private fun updateDaysCount(cnt: Int) {
        binding.weekViewDaysCount.text = requireContext().resources.getQuantityString(com.ncautomation.commons.R.plurals.days, cnt, cnt)
    }
    ...
    override fun printView() {
        val lightTextColor = resources.getColor(com.ncautomation.commons.R.color.theme_light_text_color)
        binding.apply {
