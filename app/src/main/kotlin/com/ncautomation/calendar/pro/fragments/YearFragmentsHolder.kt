...
import com.ncautomation.calendar.pro.adapters.MyYearPagerAdapter
import com.ncautomation.calendar.pro.databinding.FragmentYearsHolderBinding
import com.ncautomation.calendar.pro.helpers.Formatter
import com.ncautomation.calendar.pro.helpers.YEARLY_VIEW
import com.ncautomation.calendar.pro.helpers.YEAR_TO_OPEN
...
class YearFragmentsHolder : MyFragmentHolder(), NavigationListener {
    ...
    override fun showGoToDateDialog() {
        ...
        activity?.getAlertDialogBuilder()!!
            ...
            .setPositiveButton(com.ncautomation.commons.R.string.ok) { _, _ -> datePicked(datePicker) }
            .apply {
